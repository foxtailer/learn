...
class TestBatches(unittest.TestCase):
    ...
    def test_allocating_to_a_batch_reduces_the_available_quantity(self):
        batch = Batch("batch-001", "SMALL-TABLE", 
                            qty=20, eta=date.today())
